...
struct MovegenTests : public Test{
    ...
    void run() const override{
        ...
        run_perft_cap("rnbq1k1r/pp1Pbppp/2p5/8/2B5/8/PPP1NnPP/RNBQK2R w KQ - 1 8", 4 );

        run_perft_cap("8/1p4p1/8/q1PK1P1r/3p1k2/8/4P3/4Q3 b - - 0 1", 5 );
        run_perft_cap("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1",5 );
        run_perft_cap("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1",6 );
        //run_perft_cap("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1",7,3195901860 );
        run_perft_cap("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - 0 0", 6 );
        run_perft_cap("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - 0 0", 7 );
        run_perft_cap("r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - - 0 10",5 );
        run_perft_cap("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 0", 5 );
        run_perft_cap("8/8/8/1PpK4/5p2/4k3/8/8 b - - 0 24", 9 );

        run_perft_cap("rnbqkbnr/ppppp1pp/8/8/5pP1/P1P5/1P1PPP1P/RNBQKBNR b KQkq g3 0 3", 1 );
        run_perft_cap("rnbqkbnr/ppppp1pp/8/8/5pP1/P1P5/1P1PPP1P/RNBQKBNR b KQkq g3 0 3", 3 );
        run_perft_cap("rnbqkbnr/ppppp1pp/8/8/4Pp2/P1P5/1P1P1PPP/RNBQKBNR b KQkq e3 0 3",    1 );
        run_perft_cap("rnbqkbnr/ppppp1pp/8/8/4Pp2/P1P5/1P1P1PPP/RNBQKBNR b KQkq e3 0 3", 3 );
        run_perft_cap("1r2k2r/p1ppqpb1/bn2pnp1/3PN3/Pp2P3/1PN2Q1p/2PBBPPP/R3K2R b KQk a3 0 8", 1 );
        run_perft_cap("8/8/1k6/2b5/2pP4/8/5K2/8 b - d3 0 1", 1 );

        // run_perft_cap("2B1k2r/p4pp1/1N1pr1p1/4p1P1/4P3/3P4/P1P2PP1/R3K2R b KQk - 0 5", 2, 709 );
        run_perft_cap("2r1k2r/pP3pp1/1N1pr1p1/4p1P1/4P3/3P4/P1P2PP1/R3K2R w KQk - 1 5", 3 );
        run_perft_cap("r3k2r/pP3pp1/1N1pr1p1/4p1P1/4P3/3P4/P1P2PP1/R3K2R b KQkq - 0 4", 4);
        run_perft_cap("r3kr2/pP3pp1/1N1pr1p1/4p1P1/4P3/3P4/P1P2PP1/R3K2R w KQq - 1 5", 1 );
        run_perft_cap("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 0", 3 );
        run_perft_cap("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 0", 4 );
        run_perft_cap("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/1PN2Q1p/P1PBBPPP/R3K2R b KQkq - 0 7", 3 );
        run_perft_cap("r4rk1/p1ppqpb1/bn2pnp1/3PN3/1p2P3/1PN2Q1p/P1PBBPPP/R3K2R w KQ - 1 8", 2 );
        run_perft_cap("r3k3/p1ppqpbr/bn2pnp1/3PN3/1p2P3/1PN2Q1p/P1PBBPPP/R3K2R w KQq - 1 8", 2 );
        run_perft_cap("1r2k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/1PN2Q1p/P1PBBPPP/R3K2R w KQk - 1 8", 2 );
        run_perft_cap("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/5Q2/PPPBBPpP/R2NK2R w KQkq - 0 7", 1 );
        run_perft_cap("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/5Q1p/PPPBBPPP/R2NK2R b KQkq - 1 6", 2 );
        run_perft_cap("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1", 1);
        run_perft_cap("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1", 2);
        run_perft_cap("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1", 3);
        run_perft_cap("r1bqkbnr/pppppppp/n7/8/8/7P/PPPPPPPR/RNBQKBN1 b Qkq - 2 2", 1);
        run_perft_cap("r1bqkbnr/pppppppp/n7/8/8/7P/PPPPPPP1/RNBQKBNR w KQkq - 1 2", 2);
        run_perft_cap("rnbqkbnr/pppppppp/8/8/8/7P/PPPPPPP1/RNBQKBNR b KQkq - 0 1", 3);
        run_perft_cap("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1", 4);
        run_perft_cap("rnbqkbnr/p1pppppp/8/Pp6/8/8/1PPPPPPP/RNBQKBNR b KQkq - 0 2", 2);
        run_perft_cap("rnbqkbnr/p1pppppp/8/1p6/P7/8/1PPPPPPP/RNBQKBNR w KQkq b6 0 2", 3);
        run_perft_cap("rnbqkbnr/pppppppp/8/8/P7/8/1PPPPPPP/RNBQKBNR b KQkq a3 0 1", 4);
        run_perft_cap("rnbqkbnr/p1pppppp/8/8/1p1P4/8/PPPKPPPP/RNBQ1BNR w kq - 0 3", 1);
        run_perft_cap("rnbqkbnr/p1pppppp/8/1p6/3P4/8/PPPKPPPP/RNBQ1BNR b kq - 1 2", 2);
        run_perft_cap("rnbqkbnr/p1pppppp/8/1p6/3P4/8/PPP1PPPP/RNBQKBNR w KQkq b6 0 2", 3);
        run_perft_cap("rnbqkbnr/pppppppp/8/8/3P4/8/PPP1PPPP/RNBQKBNR b KQkq d3 0 1", 4);
        run_perft_cap("r1bqkbnr/p1pppppp/np6/8/8/4PQ2/PPPP1PPP/RNB1KBNR w KQkq - 0 3", 1);
        run_perft_cap("r1bqkbnr/pppppppp/n7/8/8/4PQ2/PPPP1PPP/RNB1KBNR b KQkq - 2 2", 2);
        run_perft_cap("r1bqkbnr/pppppppp/n7/8/8/4P3/PPPP1PPP/RNBQKBNR w KQkq - 1 2", 3);
        run_perft_cap("rnbqkbnr/pppppppp/8/8/8/4P3/PPPP1PPP/RNBQKBNR b KQkq - 0 1", 4);
        run_perft_cap("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1", 5);
        run_perft_cap("r3k3/pP3pp1/1N1pr1p1/4p1P1/4P3/3P4/P1P2PP1/R3K2r w Qq - 0 5", 1 );
        run_perft_cap("r3k2r/p1ppqpb1/bn2p1p1/3PN3/1p2P1n1/5Q1p/PPPBBPPP/R2NK2R w KQkq - 2 7", 1 );
        run_perft_cap("r3k2r/p1ppqpb1/bn1Ppnp1/4N3/1p2P3/2N2Q2/PPPBBPpP/R3K2R w KQkq - 0 6", 1 );
        run_perft_cap("8/8/8/1PpK4/5p2/4k3/8/8 b - - 0 24", 1);
        run_perft_cap("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 0", 1 );
        run_perft_cap("r3k2r/p1ppqpb1/bn1Ppnp1/4N3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R b KQkq - 0 5", 2 );
        run_perft_cap("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 0", 2 );
        run_perft_cap("r3k2r/pP3pp1/1N1pr1p1/4p1P1/4P3/3P4/P1P2PP1/R3K2R b KQkq - 0 4", 2 );
        run_perft_cap("r3k2r/pp3pp1/PN1pr1p1/4p1P1/4P3/3P4/P1P2PP1/R3K2R w KQkq - 4 4", 1 );
        run_perft_cap("r3k2r/pp3pp1/PN1pr1p1/4p1P1/4P3/3P4/P1P2PP1/R3K2R w KQkq - 4 4", 2 );
        run_perft_cap("r3k2r/pp3pp1/PN1pr1p1/4p1P1/4P3/3P4/P1P2PP1/R3K2R w KQkq - 4 4", 3 );
        run_perft_cap("r3k2r/pp3pp1/PN1pr1p1/4p1P1/4P3/3P4/P1P2PP1/R3K2R w KQkq - 4 4", 5);
        run_perft_cap("1r2k2r/1p3pp1/Pp1pr1p1/4p1P1/P3P3/3P4/2P2PP1/1R2K2R b Kk - 0 6",1 );
        run_perft_cap("1r2k2r/1p3pp1/Pp1pr1p1/4p1P1/4P3/P2P4/2P2PP1/1R2K2R w Kk - 1 6",2 );
        run_perft_cap("r3k2r/1p3pp1/Pp1pr1p1/4p1P1/4P3/P2P4/2P2PP1/1R2K2R b Kkq - 0 5",3 );
        run_perft_cap("8/2p5/3p4/1P5r/KR3p2/2k5/4P1P1/8 w - - 2 2",5 );
        run_perft_cap("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - 0 0", 4 );
        run_perft_cap("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - 0 0", 1 );
        run_perft_cap("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - 0 0", 2 );
        run_perft_cap("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - 0 0", 3 );
        run_perft_cap("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - 0 0", 5 );
        run_perft_cap("rnQ1qk1r/pp3ppp/2p5/8/1bB5/8/PPP1NKPP/RNBQ3R w - - 1 10", 1 );
        run_perft_cap("rnQq1k1r/pp3ppp/2p5/8/1bB5/8/PPP1NKPP/RNBQ3R b - - 0 9", 2);
        run_perft_cap("rnQq1k1r/pp3ppp/2p5/8/1bB5/2P5/PP2NnPP/RNBQK2R b KQ - 0 9",2 );
        run_perft_cap("rnQq1k1r/pp3ppp/2p5/8/1bB5/8/PPP1NnPP/RNBQK2R w KQ - 1 9",1 );
        run_perft_cap("rnQq1k1r/pp3ppp/2p5/8/1bB5/8/PPP1NnPP/RNBQK2R w KQ - 1 9",2 );
        run_perft_cap("rnQq1k1r/pp3ppp/2p5/8/1bB5/8/PPP1NnPP/RNBQK2R w KQ - 1 9",3 );
        run_perft_cap("rnbq1k1r/pp1Pbppp/2p5/8/2B5/8/PPP1NnPP/RNBQK2R w KQ - 1 8",2 );
        run_perft_cap("rnbq1k1r/pp1Pbppp/2p5/8/2B5/8/PPP1NnPP/RNBQK2R w KQ - 1 8",3 );
        run_perft_cap("rnbq1k1r/pp1Pbppp/2p5/8/2B5/8/PPP1NnPP/RNBQK2R w KQ - 1 8",4 );
        run_perft_cap("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1",2 );
        run_perft_cap("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1",3 );
        run_perft_cap("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1",4 );
        run_perft_cap("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1", 5 );
        run_perft_cap("2b1b3/1r1P4/3K3p/1p6/2p5/6k1/1P3p2/4B3 w - - 0 42", 5 );
        run_perft_cap("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - 0 0", 6 );
        run_perft_cap("r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - - 0 10", 4 );
        run_perft_cap("r3k1nr/p2pp1pp/b1n1P1P1/1BK1Pp1q/8/8/2PP1PPP/6N1 w kq - 0 1", 4 );
        run_perft_cap("3k4/3p4/8/K1P4r/8/8/8/8 b - - 0 1", 6);
        run_perft_cap("8/8/1k6/2b5/2pP4/8/5K2/8 b - d3 0 1", 6 );
        run_perft_cap("5k2/8/8/8/8/8/8/4K2R w K - 0 1", 6);
        run_perft_cap("3k4/8/8/8/8/8/8/R3K3 w Q - 0 1", 7 );
        run_perft_cap("r3k2r/1b4bq/8/8/8/8/7B/R3K2R w KQkq - 0 1", 4);
        run_perft_cap("r3k2r/8/3Q4/8/8/5q2/8/R3K2R b KQkq - 0 1", 5 );
        run_perft_cap("2K2r2/4P3/8/8/8/8/8/3k4 w - - 0 1", 6);
        run_perft_cap("8/8/1P2K3/8/2n5/1q6/8/5k2 b - - 0 1", 5);
        run_perft_cap("4k3/1P6/8/8/8/8/K7/8 w - - 0 1", 6);
        run_perft_cap("8/P1k5/K7/8/8/8/8/8 w - - 0 1", 6 );
        run_perft_cap("K1k5/8/P7/8/8/8/8/8 w - - 0 1", 10 );
        run_perft_cap("8/k1P5/8/1K6/8/8/8/8 w - - 0 1", 7);
        run_perft_cap("8/8/2k5/5q2/5n2/8/5K2/8 b - - 0 1", 6 );
        run_perft_cap("r1bq2r1/1pppkppp/1b3n2/pP1PP3/2n5/2P5/P3QPPP/RNB1K2R w KQ a6 0 12", 5);
        run_perft_cap("r3k2r/pppqbppp/3p1n1B/1N2p3/1nB1P3/3P3b/PPPQNPPP/R3K2R w KQkq - 11 10", 4 );
        run_perft_cap("4k2r/1pp1n2p/6N1/1K1P2r1/4P3/P5P1/1Pp4P/R7 w k - 0 6", 5);
        run_perft_cap("1Bb3BN/R2Pk2r/1Q5B/4q2R/2bN4/4Q1BK/1p6/1bq1R1rb w - - 0 1", 4);
        run_perft_cap("n1n5/PPPk4/8/8/8/8/4Kppp/5N1N b - - 0 1", 6);
        run_perft_cap("8/PPPk4/8/8/8/8/4Kppp/8 b - - 0 1", 6);
        run_perft_cap("8/2k1p3/3pP3/3P2K1/8/8/8/8 w - - 0 1", 9);
        run_perft_cap("3r4/2p1p3/8/1P1P1P2/3K4/5k2/8/8 b - - 0 1", 4 );
    ...
    void run_perft_cap(const std::string fen, int depth) const{
        Board board;
        std::cout << fen << std::endl;
        board.load_from_fen(fen);
        capture_move_recursion(board, depth);
    }
    ...
    void capture_move_recursion(Board& board, int depth) const{
        if (depth == 0) return;

        MoveList<false> move_list_non_cap(&board);
        MoveList<true>  move_list_cap(&board);

        Move move;

        size_t total_captures = 0;
        while ((move = move_list_non_cap.get()) != Move::none()){
            bool cap = board.is_capture(move);
            if (!board.make_move(move))
                continue;
            total_captures += cap;
            board.undo_move();
        ...
        size_t gen_captures = 0;
        while ((move = move_list_cap.get()) != Move::none()){
            throwable_assert(board.is_capture(move), true);
            if (!board.make_move(move))
                continue;
            gen_captures++;

            capture_move_recursion(board, depth - 1);
            board.undo_move();
        }
        throwable_assert(gen_captures, total_captures);
    }
};
